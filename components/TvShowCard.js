        ...
        {tvshow.poster_path ? (
            <div key={tvshow.id} className="relative bg-gray-100 rounded-lg shadow-md">
                ...
                <div className="p-4 mt-4">
                    <Link href={`/tvshow/${tvshow.id}`}>
                        <div className="text-lg font-semibold text-black hover:text-blue-400 overflow-hidden" style={{ maxWidth: '250px', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>
                            {tvshow.name}
                        </div>
                    </Link>
